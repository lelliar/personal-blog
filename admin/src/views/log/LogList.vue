<template>
  <div>
      <el-button class="botton" @click="$router.push('/log/edit')" style="margin-bottom:20px;">+ 添 加</el-button>
      <el-table style="opacity:0.6;" :data="data.data" border stripe>
          ...
          <el-table-column
            ...
            <template slot-scope="scope"> 
                <el-button @click="$router.push(`/log/edit/${scope.row._id}`)" type="text" size="small">编辑</el-button>
